...
class retrieval_net(nn.Module):
    def __init__(self,cfg, is_train = True):
        ...
        # self.featrue_extractor = nn.functional.adaptive_avg_pool2d()
    ...
    for epoch in range(start_epoch, end_epoch):
        ...
        for i, batch in enumerate(train_loader):
            ...
            if i % config.PRINT_FREQ == 0:
                ...
                writer.add_scalar('train_loss_trip', train_sim_loss.val, global_steps)
        ...
        for i, batch in enumerate(test_loader):
            ...
            if i % config.PRINT_FREQ == 0:
                ...
                writer.add_scalar('test_loss_trip', test_sim_loss.val, global_steps)
